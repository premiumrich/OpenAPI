...
describe Trulioo::TransactionRecordResult do
  let(:model) { Trulioo::TransactionRecordResult.new }
  let(:test_attributes) {
    {
  ...
  it "should have correct array of acceptable JSON keys" do
    expect(Trulioo::TransactionRecordResult.acceptable_attributes).to eql([
      :"TransactionID",
      :"UploadedDt",
      :"CountryCode",
      :"ProductName",
  ...
  it "should have correct array of acceptable attribute types" do
    expect(Trulioo::TransactionRecordResult.openapi_types.values).to eql([
      :"String",
      :"Time",
      :"String",
      :"String",
  ...
  it "should have correct set of nullable attributes" do
    expect(Trulioo::TransactionRecordResult.openapi_nullable).to eql(Set.new([]))
  end
  ...
  it "should correctly initialize with attributes from Hash" do
    model = Trulioo::TransactionRecordResult.new(test_attributes)
  ...
  it "should not initialize with a non-Hash argument" do
    expect { Trulioo::TransactionRecordResult.new([]) }.to raise_error(ArgumentError)
  end

  it "should not initialize with a Hash that contains an invalid attribute" do
    expect { Trulioo::TransactionRecordResult.new({ test_invalid_key: "" }) }.to raise_error(ArgumentError)
  end
  ...
  it "should correctly check object equality" do
    ...
    expect(model).to eql(Trulioo::TransactionRecordResult.new({ transaction_id: test_attributes[:transaction_id] }))
  end

  it "should correctly calculate hash code" do
    model.transaction_id = test_attributes[:transaction_id]

    expect(Trulioo::TransactionRecordResult.new({ transaction_id: test_attributes[:transaction_id] }).hash).to eql(model.hash)
  end
end
